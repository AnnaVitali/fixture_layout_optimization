...
public class CPSpiralStairStep {

    private static final String CP_FILE_PATH = "./resources/cp/LNS_cp_model_spiral_stair_step_gecode.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_cp_spiral_stair_step.json";
