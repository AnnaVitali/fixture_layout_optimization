...
public class RLSpeaker {

    private static final String RL_FILE_PATH = "./resources/rl/rl_speaker.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_rl_speaker.json";
