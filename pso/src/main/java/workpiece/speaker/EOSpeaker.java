...
public class EOSpeaker {

    private static final String EO_FILE_PATH = "./resources/expert/expert_operator_speaker.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_eo_speaker.json";
