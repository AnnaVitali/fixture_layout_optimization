...
public class EODoorPorthole {

    private static final String EO_FILE_PATH = "./resources/expert/expert_operator_door_porthole.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_eo_door_porthole.json";
