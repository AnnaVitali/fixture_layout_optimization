...
public class MIPDoorPorthole {

    private static final String MIP_FILE_PATH = "./resources/mip/mip_model_door_porthole_gurobi.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_mip_door_porthole.json";
