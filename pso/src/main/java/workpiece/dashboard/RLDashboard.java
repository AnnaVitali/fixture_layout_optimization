...
public class RLDashboard {

    private static final String RL_FILE_PATH = "./resources/rl/rl_dashboard.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_rl_dashboard.json";
