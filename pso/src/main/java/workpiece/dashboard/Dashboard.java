...
public class Dashboard implements Workpiece {
    ...
    private static final List<Float> HOLESWIDTH = List.of(
            102f, 102f, 54f, 54f, 54f, 182f
    );
    private static final List<Float> HOLESHEIGHT = List.of(
            102f, 102f, 54f, 54f, 54f, 53f
    );
    ...
    private void defineWorkpieceInequalityAndVertices(){
        ...
        PolygonGeometry.LineSegment line1 = PolygonGeometry.lineEquationFromPoints(new Tuple<>(0.0, 0.0), new Tuple<>(0.0, 220.0));
        lineEquations.add(line1);

        PolygonGeometry.LineSegment line2 = PolygonGeometry.lineEquationFromPoints(new Tuple<>(0.0, 220.0), new Tuple<>(950.0, 220.0));
        lineEquations.add(line2);

        PolygonGeometry.LineSegment line3 = PolygonGeometry.lineEquationFromPoints(new Tuple<>(950.0, 220.0), new Tuple<>(950.0, 0.0));
        lineEquations.add(line3);

        PolygonGeometry.LineSegment line4 = PolygonGeometry.lineEquationFromPoints(new Tuple<>(950.0, 0.0), new Tuple<>(0.0, 0.0));
