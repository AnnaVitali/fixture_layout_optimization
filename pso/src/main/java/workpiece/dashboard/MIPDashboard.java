...
public class MIPDashboard {

    private static final String MIP_FILE_PATH = "./resources/mip/mip_model_dashboard_gurobi.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_mip_dashboard.json";
