...
public class EOCoffeeTable {

    private static final String EO_FILE_PATH = "./resources/expert/expert_operator_coffee_table.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/tlbo_eo_coffee_table.json";
