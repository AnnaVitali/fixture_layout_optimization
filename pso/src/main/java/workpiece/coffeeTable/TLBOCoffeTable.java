...
public class TLBOCoffeTable {

    private static final String CP_FILE_PATH = "./resources/cp/cp_model_coffee_table_gurobi.json";
    private static final String RESULT_FILE_PATH = "./resources/tlbo/tlbo_cp_coffee_table.json";
