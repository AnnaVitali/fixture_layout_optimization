...
public class RLCoffeeTable {

    private static final String RL_FILE_PATH = "./resources/rl/rl_coffee_table.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_rl_coffee_table.json";
