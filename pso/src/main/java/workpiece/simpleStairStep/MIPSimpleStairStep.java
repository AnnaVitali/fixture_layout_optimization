...
public class MIPSimpleStairStep {

    private static final String MIP_FILE_PATH = "./resources/mip/mip_model_simple_stair_step_gurobi.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_mip_simple_stair_step.json";
