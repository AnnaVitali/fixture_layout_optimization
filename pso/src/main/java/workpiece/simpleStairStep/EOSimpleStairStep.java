...
public class EOSimpleStairStep {

    private static final String EO_FILE_PATH = "./resources/expert/expert_operator_simple_stair_step.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_eo_simple_stair_step.json";
