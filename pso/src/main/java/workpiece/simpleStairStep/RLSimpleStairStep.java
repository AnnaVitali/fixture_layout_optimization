...
public class RLSimpleStairStep {

    private static final String RL_FILE_PATH = "./resources/rl/rl_simple_stair_step.json";
    private static final String RESULT_FILE_PATH = "./resources/pso/pso_rl_simple_stair_step.json";

    public static void main(String[] args) {
        String content;
        try {
            content = new String(Files.readAllBytes(Paths.get(RL_FILE_PATH)));
        } catch (IOException e) {
        ...
        GeometryConstraint geometryConstraint = new GeometryConstraint(simpleStairStep.getInequalities(), simpleStairStep.getVertices().stream().toList(),
        ...
        ParticleSwarmOptimization pso = new ParticleSwarmOptimization(
                ...
                noOverlapConstraint,
                fixtureConstraints,
                simpleStairStep.getMinFix(),
                simpleStairStep.getMaxFix()
        );
