...
public class ExeprtOperatorSpiralStairStep {

    private static final String FILE_PATH = "./resources/expert/expert_operator_spiral_stair_step.json";

    public static void main(String[] args) {
        double [] expertX = {120.00, 447.602, 465.102, 2500.0};
        double[] expertY = {124, 43.466, 196.208, 1500.0};
        double[] expertAngle = {0.0, 348.0, 0.0, 0.0};
        double[] startingAngle = {0.0, 0.0, 0.0, 0.0};
        double[] expertT = {1.0, 2.0, 1.0, 0.0};
