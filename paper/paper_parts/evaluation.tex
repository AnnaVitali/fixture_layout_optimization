...
Figure~\ref{fig:comparison_plot2} also reports the improvement achieved by initializing PSO with the expert layout. For all the considered workpieces, PSO generates layouts that outperform the expert solution, demonstrating its effectiveness as a refinement technique.
