...
Once an episode has ended, the best policy found so far is updated, and the environment is arranged for the next episode, as reported in lines~\ref{alg:q_new_ep_start}--\ref{alg:q_new_ep_end} of Algorithm~\ref{alg:qlearning_fixtures}.
